...
export function renderGallery(
  ...
  setShowSlideshow: (v: boolean) => void,
  setCurrentIndex: (v: number) => void,
) {
  if (images.length === 0) return null;

  // Nếu chỉ có 1 ảnh, chỉ render 1 ảnh lớn, không chia bố cục
  if (images.length === 1) {
    return (
      <div className="w-full h-[315px] mb-4">
        <div
  ...
  // Nếu có nhiều hơn 1 ảnh, chia bố cục như cũ
  return (
